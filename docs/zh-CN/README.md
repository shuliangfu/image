...
[![Tests](https://img.shields.io/badge/tests-60%20%E9%80%9A%E8%BF%87-green)](./TEST_REPORT.md)
...
- [客户端文档](./client/README.md) - 客户端使用说明
...
- **依赖**：服务端需要 ImageMagick（可选），客户端使用浏览器原生 API

---

## 变更日志

**v1.0.2** (2026-02-19) — 变更：i18n 在模块加载时自动初始化，入口文件不再调用
init。[完整变更](./CHANGELOG.md)
